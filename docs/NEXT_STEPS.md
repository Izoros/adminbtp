...
1. appliquer les migrations `archive_runs` et `whatsapp_command_requests` sur une preproduction Supabase controlee
...
4. relier la supervision locale a un canal d'alerte externe pour les executions `failed` ou bloquees
