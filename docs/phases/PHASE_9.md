...
- action serveur Supabase pour creer ou mettre a jour une liaison client Odoo
...
la page reste maintenant en vrai mode Supabase vide et permet de creer la
liaison client Odoo depuis l'interface.

## Points de securite

- mappings reserves aux membres de l'organisation
- ecriture du mapping client protegee par scope organisation serveur
...
- validation de creation et mise a jour du mapping client Odoo : OK
